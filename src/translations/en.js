export const en = {
  ...
  // Meta data
  'meta.title': 'Alora | Web Development & Digital Solutions for Businesses',
  'meta.description': 'We design and develop websites, ecommerce and custom systems for businesses that want to grow. Professional web development, landing pages, Google Ads and AI.',
  'meta.webExpressTitle': 'Alora | Web Express - Web Design that Sells',
  'meta.thankYouTitle': 'Alora | Message Sent!',
  'meta.aplicacionesWebTitle': 'Alora | Web Applications',
  'meta.desarrolloWebTitle': 'Alora | Web Development',
  'meta.mantenimientoWebTitle': 'Alora | Website Maintenance',
  'meta.landingPagesTitle': 'Alora | Landing Pages',
  'meta.ecommerceTitle': 'Alora | Ecommerce',
  'meta.googleAdsTitle': 'Alora | Google Ads',
  'meta.atencionClienteIATitle': 'Alora | AI Customer Service',
  'meta.solucionesTitle': 'Alora | Solutions',
  'meta.contactTitle': 'Alora | Contact',
  'meta.notFoundTitle': 'Alora | Page Not Found',
  ...
  'targetCompanies.title': 'What type of companies do we work with?',
  'targetCompanies.subtitle': 'We don\'t work with everyone. We focus on organizations that are already operating and need real digital structure to grow, optimize, or scale.',
  'targetCompanies.b2b.title': 'B2B Companies and Professional Services',
  'targetCompanies.b2b.desc': 'Organizations that sell to other businesses and need to communicate authority, explain complex processes, and generate qualified business opportunities.',
  'targetCompanies.b2b.item1': 'Consulting firms, technology companies, professional studios',
  'targetCompanies.b2b.item2': 'Industrial companies, businesses with consultative sales cycles',
  'targetCompanies.smes.title': 'Growing SMEs',
  'targetCompanies.smes.desc': 'Businesses that have already validated their offer and now need to professionalize their digital presence and organize their operations.',
  'targetCompanies.smes.item1': 'Companies with internal teams',
  'targetCompanies.smes.item2': 'Businesses that receive constant inquiries',
  'targetCompanies.smes.item3': 'Companies that want to scale with clearer processes',
  'targetCompanies.ecommerce.title': 'Ecommerce with scaling intentions',
  'targetCompanies.ecommerce.desc': 'Online stores looking for more than just "being online". They need to optimize conversion, technical structure, and processes.',
  'targetCompanies.ecommerce.item1': 'Brands with active catalogs',
  'targetCompanies.ecommerce.item2': 'Companies investing in advertising',
  'targetCompanies.ecommerce.item3': 'Businesses that want to improve performance and shopping experience',
  'targetCompanies.startups.title': 'Startups with funding or in growth phase',
  'targetCompanies.startups.desc': 'Teams that need to launch quickly, validate products, or structure a solid platform to grow.',
  ...
  'whyAlora.subtitle': 'We don\'t compete for volume. You don\'t work with an automated system where you\'re just another project on the list. You work with a team that understands technology must adapt to the business, not the other way around.',
  'whyAlora.personalized.title': 'Real personalized follow-up',
  'whyAlora.personalized.desc': 'Each project has direct support and continuous monitoring.',
  'whyAlora.personalized.item1': 'We don\'t completely delegate the relationship to junior accounts or disappear after delivery',
  'whyAlora.personalized.item2': 'We understand objectives, changes, and business evolution',
  'whyAlora.personalized.item3': 'We get involved beyond the initial development',
  'whyAlora.personalized.item4': 'You\'re not a ticket in a system. You\'re a project with real context and priorities',
  'whyAlora.flexibility.title': 'Flexibility and adaptation',
  'whyAlora.flexibility.desc': 'Businesses change. Priorities change. Decisions evolve.',
  'whyAlora.flexibility.item1': 'We don\'t work with rigid processes that block necessary adjustments',
  'whyAlora.flexibility.item2': 'We adapt development when the project requires it, maintaining clarity and order',
  'whyAlora.flexibility.item3': 'Technology should accompany business evolution, not limit it',
  'whyAlora.bilingual.title': 'Bilingual talent (Spanish / English)',
  'whyAlora.bilingual.desc': 'We work with teams and clients in different markets. Our team operates fluently in Spanish and English.',
  'whyAlora.bilingual.item1': 'Collaboration with international companies',
  'whyAlora.bilingual.item2': 'Clear documentation',
  'whyAlora.bilingual.item3': 'Direct communication without intermediaries',
  'whyAlora.bilingual.item4': 'Especially relevant for B2B companies, startups, and projects with international projection',
  'whyAlora.strategic.title': 'Strategic approach, not just technical',
  'whyAlora.strategic.desc': 'We don\'t start by writing code. We start by understanding:',
  'whyAlora.strategic.item1': 'What you want to achieve',
  'whyAlora.strategic.item2': 'What problem you\'re solving',
  ...
  'contactPage.hero.badge': 'Digital Transformation',
  'contactPage.hero.title': 'Let\'s build the digital future of your business together',
  'contactPage.hero.subtitle': 'At GlobalAlora we don\'t just develop software. We create intelligent solutions that drive growth, optimize operations, and connect with your customers in meaningful ways.',
  'contactPage.hero.cta': 'Your vision + our expertise = extraordinary results',
  'contactPage.values.title': 'Why choose us',
  'contactPage.values.innovation.title': 'Constant Innovation',
  'contactPage.values.innovation.desc': 'We always explore new technologies and methodologies to take your business to the next level.',
  'contactPage.values.partnership.title': 'Real Partnership',
  'contactPage.values.partnership.desc': 'We are not just providers, we are strategic partners committed to your success.',
  'contactPage.values.execution.title': 'Fast Execution',
  'contactPage.values.execution.desc': 'We transform your ideas into reality with agility and technical precision.',
  'contactPage.form.title': 'Let\'s start the conversation',
  'contactPage.form.subtitle': 'Tell us about your project and we\'ll respond with a personalized proposal in less than 24 hours.',
